...
if [ -f "$PAINEL_HOME/bin/select_html" ]; then
	...
	$PAINEL_HOME/bin/select_html $PAINEL_HOME/running/select_html_OperadorMaquina.cfg 1>>$PAINEL_HOME/log/select_html.log 2>&1
	...
	$PAINEL_HOME/bin/select_html $PAINEL_HOME/running/select_html_SupervisorMaquina.cfg 1>>$PAINEL_HOME/log/select_html.log 2>&1
	...
	$PAINEL_HOME/bin/select_html $PAINEL_HOME/running/select_html_FornoEletrico.cfg 1>>$PAINEL_HOME/log/select_html.log 2>&1
	...
	$PAINEL_HOME/bin/select_html $PAINEL_HOME/running/select_html_All.cfg 1>>$PAINEL_HOME/log/select_html.log 2>&1
