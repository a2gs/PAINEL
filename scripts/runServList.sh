...
if [ -f "$PAINEL_HOME/bin/servList" ]; then
	...
	$PAINEL_HOME/bin/servList $PAINEL_HOME/servList_7.cfg 1>>$PAINEL_HOME/log/servList.log 2>&1
	...
	$PAINEL_HOME/bin/servList $PAINEL_HOME/servList_6.cfg 1>>$PAINEL_HOME/log/servList.log 2>&1
	...
	$PAINEL_HOME/bin/servList $PAINEL_HOME/servList_5.cfg 1>>$PAINEL_HOME/log/servList.log 2>&1
	...
	$PAINEL_HOME/bin/servList $PAINEL_HOME/servList_4.cfg 1>>$PAINEL_HOME/log/servList.log 2>&1
	...
	$PAINEL_HOME/bin/servList $PAINEL_HOME/servList_3.cfg 1>>$PAINEL_HOME/log/servList.log 2>&1
	...
	$PAINEL_HOME/bin/servList $PAINEL_HOME/servList_2.cfg 1>>$PAINEL_HOME/log/servList.log 2>&1
	...
	$PAINEL_HOME/bin/servList $PAINEL_HOME/servList_1.cfg 1>>$PAINEL_HOME/log/servList.log 2>&1
	...
	$PAINEL_HOME/bin/servList $PAINEL_HOME/servList_0.cfg 1>>$PAINEL_HOME/log/servList.log 2>&1
